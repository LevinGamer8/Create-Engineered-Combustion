...
import dev.engineeredcombustion.content.engine.crankshaft.CrankshaftBlockItem;
import dev.engineeredcombustion.content.engine.cylinder.PistonAssemblyItem;
...
public class ECItems {
	 ...
	 */
	public static final DeferredHolder<Item, PistonAssemblyItem> PISTON_ASSEMBLY =
		ITEMS.register("piston_assembly", () -> new PistonAssemblyItem(new Item.Properties().stacksTo(16)));

	/**
	 * A subclass only so that a worn crankcase can say so in the player's hand -
	 * see {@link CrankshaftBlockItem}. The wear itself rides on the stack as a Data
	 * Component and is put there by the block's loot table.
	 */
	public static final DeferredHolder<Item, CrankshaftBlockItem> CRANKSHAFT =
		ITEMS.register("crankshaft", () -> new CrankshaftBlockItem(ECBlocks.CRANKSHAFT.get(), new Item.Properties()));
